# As you complete each challenge, RUN THE CODE to ensure it works. You can do this by:
  ...
  # If you are in this
  #directory, you'd run `ruby each.rb`.

# Challenge 1
# Use the each method to print out a complete sentence stating the weather using the
#Array below:
weather_options = ["sunny", "snowy", "freezing", "partly cloudy", "drizzly"]
weather_options.each do |weather_option|
  puts "Today's weather is #{weather_option}."
end
...
# Record yourself live-coding and talking through either Challenge 1 or 2. The
#recording doesn't
# have to be the first time you are solving the problem. Use technical vocabulary
